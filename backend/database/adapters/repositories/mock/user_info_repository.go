...
// NewUserInfoRepository creates a new instance of UserInfoRepository. It also registers a cleanup function to assert the mocks expectations.
func NewUserInfoRepository(t testing.TB) *UserInfoRepository {
