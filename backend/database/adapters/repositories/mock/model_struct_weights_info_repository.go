...
type mockConstructorTestingTNewModelStructWeightsInfoRepository interface {
	mock.TestingT
	Cleanup(func())
}

// NewModelStructWeightsInfoRepository creates a new instance of ModelStructWeightsInfoRepository. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewModelStructWeightsInfoRepository(t mockConstructorTestingTNewModelStructWeightsInfoRepository) *ModelStructWeightsInfoRepository {
